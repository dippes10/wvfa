...
function RotatingGlobe({
  ...
  // Configure textures. Three.js textures are mutable-by-design objects
  // (there's no immutable equivalent for colorSpace/anisotropy), so this
  // mutation is intentional and required.
